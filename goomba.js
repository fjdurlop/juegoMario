...
function Goomba(x, y,map) {
    ...
    this.sprite = new Sprite(x, y, 16, 16, 4, goomba);

    this.sprite.addAnimation(); //list of animations
    this.sprite.addKeyframe(GOOMBA_NORMAL, [0, 0, 16, 16]);
    this.sprite.addKeyframe(GOOMBA_NORMAL, [16, 0, 16, 16]);
    this.sprite.addAnimation();
    this.sprite.addKeyframe(GOOMBA_PRESSED, [32, 0, 16, 16]);
...
Goomba.prototype.collisionTop = function () {
	var box = new Box(this.sprite.x + 2+5, this.sprite.y-1, this.sprite.x + this.sprite.width - 4-5, this.sprite.y + 2);
